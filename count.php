...
$usual_nvf;
$usual_nve;
$query1="SELECT count(id) as count from messjoin where (MENU='VEG' AND active=1 AND late=0)";
$query2="SELECT count(id) as count from messjoin where (MENU='VC'AND active=1 AND late=0)";
$query3="SELECT count(id) as count from messjoin where (MENU='VE' AND active=1 AND late=0)";
$query4="SELECT count(id) as count from messjoin where (MENU='VF'AND active=1 AND late=0)";
$query5="SELECT count(id) as count from messjoin where (MENU='NV' AND active=1 AND late=0)";
$query6="SELECT count(id) as count from messjoin where (MENU='NVC' AND active=1 AND late=0)";
$query7="SELECT count(id) as count from messjoin where (MENU='NVF' AND active=1 AND late=0)";
$query8="SELECT count(id) as count from messjoin where (MENU='NVE' AND active=1 AND late=0)";
$query9="SELECT count(id) as count from messjoin where (MENU='VFF' AND active=1 AND late=0)";
$query10="SELECT count(id) as count from messjoin where (MENU='VFC'AND active=1 AND late=0)";
$query11="SELECT count(id) as count from messjoin where (MENU='NVFF' AND active=1 AND late=0)";
$query12="SELECT count(id) as count from messjoin where (MENU='NVFC' AND active=1 AND late=0)";
$query14="SELECT count(id) as count from coupon where (Milk='1')";
$t=date("t");
$d=date("d");

if($date<"15")
{
	$query13 = "SELECT count(id) as count from milkfirsthalf where id!=0";
}
else {
        if($d==$t)
        {
	 $query13 = "SELECT count(id) as count from milkfirsthalf where id!=0";
        ...
        {
         $query13 = "SELECT count(id) as count from milksecondhalf where id!=0";
        }
}
...
$milkcount = $milkcount + $milkcoupon;
//coupon part veg
...
$query1="SELECT count(id) as count from messjoin where active=1 and late=0";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
	$usualtea=$row['count'];
...
<strong>  <a href="optioncomm.php">Home/</a><a href="count.php">Count/</a></strong>
  <p><strong></p>
