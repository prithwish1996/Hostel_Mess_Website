...
<div class="background"></div>
  <strong>  <a href="optioncomm.php">Home/</a><a href="insidecoupon.php">Coupon/</a><a href="editlatecoupon.php">EditLateCoupon</a></strong>
  <h2 align="center"><u>EDIT LATE COUPON</u></h2>
  </body>
  </html>
<?php
...
if(isset($_POST['view']))
  {
         ...
         $id = $_POST['srno'];
		  $query0 = "select id from latecoupon";
	  ...
	  if($flag==1)
	  {
        $query = "select * from latecoupon where id='$id' ";
	  ...
	  if(isset($_POST['del']))
 {
	 ...
	 if($id=="")
	 {
		...
		$que= "DELETE FROM latecoupon WHERE id='$id'";
...
if(isset($_POST['milk']))
 ...
 $query = "update latecoupon set Name='$name',room='$room',Menu='$menu',Breakfast='$breakfast',Lunch='$lunch',Tea='$tea',TeaSnacks='$teasnacks',Snacks='$snacks',Dinner='$dinner',Milk='$milk' where id='$id'";
...
<p><strong></strong</p>
<section>
<form action="editlatecoupon.php" method="post">
...
<input id="submit" type="submit" name="submit" value="Submit" onclick="return confirm('Are you sure you want to update late coupon?')">
