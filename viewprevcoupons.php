...
<body>
  ...
  <strong>  <a href="optioncomm.php">Home/</a><a href="insidecoupon.php">Coupon/</a><a href="viewprevcoupons.php">ViewPreviousCoupons</a></strong>
  ...
  // }
      $query = "select * from prevcoupon";
      $query1 = "select * from prevlatecoupon";
