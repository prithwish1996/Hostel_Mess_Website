...
$usual_nvf;
$usual_nve;
$query1="SELECT count(id) as count from feastjoin where (MENU='VEG')";
$query2="SELECT count(id) as count from feastjoin where (MENU='VC')";
$query3="SELECT count(id) as count from feastjoin where (MENU='VE')";
$query4="SELECT count(id) as count from feastjoin where (MENU='VF')";
$query5="SELECT count(id) as count from feastjoin where (MENU='NV')";
$query6="SELECT count(id) as count from feastjoin where (MENU='NVC')";
$query7="SELECT count(id) as count from feastjoin where (MENU='NVF')";
$query8="SELECT count(id) as count from feastjoin where (MENU='NVE')";
$query9="SELECT count(id) as count from feastjoin where (MENU='VFF')";
$query10="SELECT count(id) as count from feastjoin where (MENU='VFC')";
$query11="SELECT count(id) as count from feastjoin where (MENU='NVFF')";
$query12="SELECT count(id) as count from feastjoin where (MENU='NVFC')";
$query14="SELECT count(id) as count from feastcoupon where (Milk='1')";
$t=date("t");
$d=date("d");
...
while($row=mysqli_fetch_assoc($result))
{
	$milkcoupon=$row['count'];
}
$milkcount = $milkcoupon;
//coupon part veg

$query1="SELECT count(id) as count from feastcoupon where Menu='VEG' and Breakfast=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='VEG' and Lunch=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='VEG' and Dinner=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='VC' and Breakfast=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='VC' and Lunch=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='VC' and Dinner=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='VE' and Breakfast=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='VE' and Lunch=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='VE' and Dinner=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='VF' and Breakfast=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='VF' and Lunch=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='VF' and Dinner=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
	$couponvegfishdinner=$row['count'];
}
$query1="SELECT count(id) as count from feastcoupon where Menu='VFF' and Breakfast=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='VFF' and Lunch=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='VFF' and Dinner=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
	$couponvegfishfrydinner=$row['count'];
}
$query1="SELECT count(id) as count from feastcoupon where Menu='VFC' and Breakfast=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='VFC' and Lunch=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='VFC' and Dinner=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='NV' and Breakfast=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='NV' and Lunch=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='NV' and Dinner=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='NVC' and Breakfast=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='NVC' and Lunch=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='NVC' and Dinner=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='NVE' and Breakfast=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='NVE' and Lunch=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='NVE' and Dinner=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='NVF' and Breakfast=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='NVF' and Lunch=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='NVF' and Dinner=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
	$couponnvfdinner=$row['count'];
}
$query1="SELECT count(id) as count from feastcoupon where Menu='NVFF' and Breakfast=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='NVFF' and Lunch=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='NVFF' and Dinner=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
	$couponnvfishfrydinner=$row['count'];
}
$query1="SELECT count(id) as count from feastcoupon where Menu='NVFC' and Breakfast=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='NVFC' and Lunch=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
$query1="SELECT count(id) as count from feastcoupon where Menu='NVFC' and Dinner=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
//tea part
$query1="SELECT count(id) as count from feastcoupon where Tea=1 OR TeaSnacks=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
	$coupontea=$row['count'];
...
$query1="SELECT count(id) as count from feastjoin";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
	$usualtea=$row['count'];
...
$query1="SELECT count(id) as count from feastcoupon where TeaSnacks=1 OR Snacks=1";
$result=mysqli_query($link,$query1);
while($row=mysqli_fetch_assoc($result))
{
...
<strong>  <a href="optioncomm.php">Home/</a><a href="feasthome.php">MessFeast/</a><a href="feastcount.php">FeastCount/</a>
  <p><strong></strong></p>
...
<div class ="milk">
	...
	<table id='tands' border='4'><tr bgcolor='#979A9A'><th>MILK COUNT</th></tr>
    <tr bgcolor='#D0D3D4'>
