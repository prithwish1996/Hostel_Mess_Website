...
<div class="background"></div>
  <strong>  <a href="optioncomm.php">Home/</a><a href="feasthome.php">MessFeast/</a><a href="feastcouponhome.php">FeastCouponHome/</a><a href="feasteditcoupon.php">EditFeastCoupon/</a></strong>
  <h2 align="center"><u>EDIT FEAST COUPON</u></h2>
  </body>
  </html>
<?php
...
if(isset($_POST['view']))
  {
      ...
      $query0 = "select id from feastcoupon";
    ...
    if($flag==1)
    {
       $query = "select * from feastcoupon where id='$id' ";
   ...
   if(isset($_POST['del']))
 {
   ...
   if($id=="")
   {
    ...
    $que= "DELETE FROM feastcoupon WHERE id='$id'";
...
if(isset($_POST['milk']))
  ...
  $query="SELECT COUNT(id) as count FROM feastcoupon";
 ...
 $query = "update feastcoupon set Name='$name',room='$room',Menu='$menu',Breakfast='$breakfast',Lunch='$lunch',Tea='$tea',TeaSnacks='$teasnacks',Snacks='$snacks',Dinner='$dinner',Milk='$milk' where id='$id'";
...
<p><strong></strong</p>
<section>
<form action="feasteditcoupon.php" method="post">
...
<input id="submit" type="submit" name="submit" value="Submit" onclick="return confirm('Are you sure you want to update FeastCoupon?')">
<input id="del" type="submit" name="del" value="Delete" onclick="return confirm('Are you sure you want to Delete FeastCoupon?')">
</form>
</section>
</body>
</HTML>