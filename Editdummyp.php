...
<div class="background"></div>
    <strong>  <a href="expcomm.php">Home/</a><a href="Editdummyp.php">EditPurchases</a></strong>
      <h2 align="center"><u>EDIT DUMMY_PURCHASES</u></h2>
      <p><strong></strong</p>
<?php
...
?>
  ...
  <section>
    <font color="white">
    <form id="form" action="Editdummyp.php" method="post">
      <li id="date">
  ...
  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Date&nbsp&nbsp&nbsp&nbsp
    ...
    <li id="exp">
      ...
      <input type="number" step="any" name="exp" min="0" value="<?php echo @$expp;?>"><br>
</li>
<li id="exu">
  Edit Expenditure Unpaid
  <input type="number" step="any"  name="exu" min="0" value="<?php echo @$expup;?>"><br>
</li>
<li id="esp">
  &nbsp&nbspEdit Establishment Paid&nbsp
  <input type="number" step="any"  name="esp" min="0" value="<?php echo @$estp;?>">
</li>
<li id="esu">
  <p align="left" id=hi>&nbsp&nbsp&nbsp&nbsp&nbsp&nbspEdit Establishment Unpaid
    <input type="number" step="any" name="esu" min="0" value="<?php echo @$estup;?>"></p><br>
</li>
      <li id="submit">
